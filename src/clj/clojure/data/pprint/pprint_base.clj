...
(def ^{:private true} write-option-table
     {;:array            *print-array*
      :base             'clojure.data.pprint/*print-base*,
      ;;:case             *print-case*,
      :circle           'clojure.data.pprint/*print-circle*,
      ;;:escape           *print-escape*,
      ;;:gensym           *print-gensym*,
      :length           'clojure.core/*print-length*,
      :level            'clojure.core/*print-level*,
      :lines            'clojure.data.pprint/*print-lines*,
      :miser-width      'clojure.data.pprint/*print-miser-width*,
      :dispatch         'clojure.data.pprint/*print-pprint-dispatch*,
      :pretty           'clojure.data.pprint/*print-pretty*,
      :radix            'clojure.data.pprint/*print-radix*,
      :readably         'clojure.core/*print-readably*,
      :right-margin     'clojure.data.pprint/*print-right-margin*,
      :suppress-namespaces 'clojure.data.pprint/*print-suppress-namespaces*})
...
clojure.data.pprint.dispatch.clj."
  {:added "1.2"}
  [function]
...
and :suffix."
  ...
  (let [[options body] (parse-lb-options #{:prefix :per-line-prefix :suffix} args)]
    `(do (if (#'clojure.data.pprint/level-exceeded) 
           (.write ^java.io.Writer *out* "#")
           (do 
             (push-thread-bindings {#'clojure.data.pprint/*current-level*
                                    (inc (var-get #'clojure.data.pprint/*current-level*))
                                    #'clojure.data.pprint/*current-length* 0})
             (try  
              (#'clojure.data.pprint/start-block *out*
                           ~(:prefix options) ~(:per-line-prefix options) ~(:suffix options))
              ~@body
              (#'clojure.data.pprint/end-block *out*)
              (finally 
               (pop-thread-bindings)))))
         nil)))
